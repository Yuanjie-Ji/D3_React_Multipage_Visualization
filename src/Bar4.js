...
const Bar4 = () => {
  ...
  return (
    ...
    <button onClick={handleButtonClick} style={{ position: 'absolute', zIndex: 3, left: '580px', marginLeft: "900px", marginTop: "200px"}}>
      {buttonText}
    </button>
    <div
      ref={tooltipRef}
    ...
    <img
      ...
      style={{ position: 'absolute', zIndex: 1, width: '732px', height: '732px', marginLeft: "500px", marginTop: "200px"}}
    />
    <svg
      ref={svgRef}
      viewBox="0 0 732 732"
      style={{ position: 'absolute', zIndex: 2, width: '732px', height: '732px', marginLeft: "500px", marginTop: "200px" }}
    />  
  </div>
);
}
